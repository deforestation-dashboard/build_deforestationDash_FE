...
const DashYear2020 = (props) => {
	const filteredByYear = props.countryData.filter((item) => item.year === 2020);
	...
	console.log('fromDashYear2020', filteredByYear);
	...
	return (
		<div className="dash-year">
			<div className="country-map-container">
				{props.countryData && (
					<CountryMap rawData={props.rawData} countryData={props.countryData} year={2020} />
				)}
			</div>
