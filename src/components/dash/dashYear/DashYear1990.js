...
const DashYear1990 = (props) => {
	const filteredByYear = props.countryData.filter((item) => item.year === 1990);
	...
	return (
		<div className="dash-year">
			<div className="country-map-container">
				{props.countryData && (
					<CountryMap rawData={props.rawData} countryData={props.countryData} year={1990} />
				)}
			</div>
