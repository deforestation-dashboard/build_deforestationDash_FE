...
const DashYear2010 = (props) => {
	const filteredByYear = props.countryData.filter((item) => item.year === 2010);
	...
	console.log('fromDashYear2010', filteredByYear);
